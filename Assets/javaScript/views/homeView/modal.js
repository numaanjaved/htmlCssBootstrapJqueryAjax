...
let modal = ([profilePic, userName, userEmail, userContactNum, userAddress, userBio, id = null]) => {
    let modalMainContainer = createNewElement(["section", "user_modal", usersDataMainContainer, null, { id: `${id}` }]);
    let modalImageContainer = createNewElement(["div", "image_container", modalMainContainer]);
